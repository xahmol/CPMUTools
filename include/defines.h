...
// Defines for default colours
#define colorText vdcLightYellow + vdcAltChrSet
#define colorError vdcLightRed + vdcAltChrSet
#define colorSuccess vdcLightGreen + vdcAltChrSet
#define colorDirEntry vdcWhite + vdcAltChrSet
#define colorSelect vdcDarkCyan + vdcRvsVid + vdcAltChrSet
...
#define BUILD_MONTH_CH1 ((BUILD_MONTH_IS_JAN) ? '1' : (BUILD_MONTH_IS_FEB) ? '2' \
